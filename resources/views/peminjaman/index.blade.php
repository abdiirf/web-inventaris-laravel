        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <a href="{{ route('peminjaman.create') }}" class="btn btn-success mb-2">Tambah Peminjaman</a>
                                    ...
                                    @foreach ($peminjamans as $index => $peminjaman)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <img src="{{ Storage::url('public/posts/').$peminjaman->barang->image }}" class="rounded" style="width: 150px">
                                            </td>
